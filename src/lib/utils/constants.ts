...
/**
 * Mega menü alt kategorileri — kategori slug'ı → `external_tags` değerleri.
 * Değerler DB'deki gerçek (küçük harf) `external_tags` ile birebir eşleşir;
 * kategori sayfası `?alt=<deger>` ile `deals.external_tags` üzerinde `contains`
 * filtresi uygular. UI bunları `capitalize` ile gösterir. Listede olmayan
 * (envanterde karşılığı bulunmayan) etiketler bilinçli olarak yoktur — ölü
 * filtre/0-sonuç linki oluşmasın. Kaynak: firsatbufirsat alt kategori taksonomisi.
 */
export const CATEGORY_SUBCATEGORIES: Record<string, readonly string[]> = {
  tiyatro: [
    ...
    'yetişkin tiyatrosu',
    'çocuk tiyatrosu',
    'anadolu yakası tiyatro',
    'müzikal',
  ],
  konser: ["90'lar gecesi konseri"],
  aktivite: [
    'tema park',
    'hayvanat bahçesi',
    'havuz ve plaj',
  ...
  turlar: [
    ...
    'kahvaltı dahil tur',
    'bayram turları',
    'uçak bileti dahil tur',
    'akşam yemeği dahil tur',
    ...
    'ara tatil turları',
    'tekne turu',
    'öğle yemeği dahil tur',
    'erken rezervasyon turları',
    '29 ekim turları',
    'izmir çıkışlı turlar',
    'cruise',
    '15 temmuz turları',
    'bisiklet turu',
  ],
  'sehir-otelleri': ['avrupa yakası otelleri', 'anadolu yakası otelleri'],
  'tatil-otelleri': [
    'yakın çevre oteli',
    'bodrum otelleri',
    'ağva otelleri',
  ...
  kurs: ['eğitim', 'dans kursu', 'atölye', 'güzel sanatlar kursu'],
};
